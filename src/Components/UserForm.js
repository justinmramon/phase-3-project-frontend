...
function UserForm({allUsers, setAllUsers}) {
    ...
    return (
        <div class="max-w-xs rounded overflow-hidden mt-8 pb-80">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <br></br>
                <button class="bg-transparent hover:bg-slate-400 text-white font-semibold hover:text-white py-2 px-4 border border-white rounded mx-16 mb-8">Create</button>
            </form>
        </div>
